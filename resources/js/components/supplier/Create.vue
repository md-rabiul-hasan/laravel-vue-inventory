                  ...
                  <form @submit.prevent="storeSupplier" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" v-model="form.shopname" id="exampleInputEmail1" />
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <br>
                          <input type="file" class="custom-file-input" id="customFile" @change="supplierPhotoSelect">
                          <label class="custom-file-label" for="customFile">Supplier Photo</label>
                        </div>
                    </div>
